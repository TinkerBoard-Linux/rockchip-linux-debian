...
static char *physNames [64][5] =
        {
                ...
                {"   GPIO0B3", "   I2C1SDA", "       ",     "       ",    "       "},
                {"0v        ", "0v        ", "0v     ",     "0v     ",    "0v     "},//5,6
                {"   GPIO0B0", "CLK32KOUT0", "  CLK32KIN",  "       ",    "       "},
                {"GPIO0C1   ", "UART0TX   ", "PWM2M0    ",  "      ",     "       "},//7,8
                {"0v        ", "0v        ", "0v     ",     "0v     ",    "0v     "},
                {"GPIO0C0   ", "UART0RX   ", "PWM2M0    ",  "       ",    "       "},//9,10
                {"   GPIO4C2", " SPI3CLKM1", "   PWM14M1",  "       ",    "       "},
                {"GPIO3A3   ", "I2S3SCLKM0", "       ",     "       ",    "       "},//11,12
                {"   GPIO4C3", "SPI3MOSIM1", " PWM15IRM1",  "       ",    "       "},
                {"0v        ", "0v        ", "0v     ",     "0v     ",    "0v     "},//13,14
                {"   GPIO4C5", "SPI3MISOM1", "   PWM12M1",  " UART9TXM1", "       "},
                {"GPIO0C7   ", "UART0CTSn ", "PWM0M1    ",  "       ",    "       "},//15,16
                {"      3.3v", "      3.3v", "   3.3v",     "   3.3v",    "   3.3v"},
                {"GPIO0C4   ", "UART0RTSn ", "PWM5      ",  "       ",    "       "},//17,18
                {"   GPIO2C3", "SPI2MOSIM0", "       ",     "       ",    "       "},
                {"0v        ", "0v        ", "0v     ",     "0v     ",    "0v     "},//19,20
                {"   GPIO2C2", "SPI2MISOM0", "       ",     "       ",    "       "},
                {"GPIO3C5   ", "SPDIFTXM1 ", "PWM15IRM0 ",  "       ",    "       "},//21,22
                {"   GPIO2C1", " SPI2CLKM0", "       ",     "       ",    "       "},
                {"GPIO2C4   ", "SPI2CS0M0 ", "     ",       "       ",    "       "},//23,24
                {"        0v", "        0v", "     0v",     "     0v",    "     0v"},
                {"GPIO2C5   ", "SPI2CS1M0 ", "       ",     "       ",    "       "},//25,26
                {"   GPIO3B4", " I2C5SDAM0", "       ",     "       ",    "       "},
                {"GPIO3B3   ", "I2C5SCLM0 ", "       ",     "       ",    "       "},//27,28
                {"   GPIO4C6", " SPI3CS0M1", "   PMW13M1",  " UART9RXM1", "       "},
                {"0v        ", "0v        ", "0v     ",     "0v     ",    "0v     "},//29.30
                {"   GPIO0C6", "    PWM7IR", "       ",     "       ",    "       "},
                {"GPIO3B2   ", "UART4TXM1 ", "PWM9M0    ",  "       ",    "       "},//31,32
                {"   GPIO3B1", " UART4RXM1", "     PWM8M0", "       ",    "       "},
                {"0v        ", "0v        ", "0v     ",     "0v     ",    "0v     "},//33,34
                {"   GPIO3A4", " I2SLRCKM0", "       ",     "       ",    "       "},
                {"GPIO2B3   ", "UART1RXM0 ", "       ",     "       ",    "       "},//35,36
                {"   GPIO2B4", " UART1TXM0", "       ",     "       ",    "       "},
                {"GPIO3A6   ", "I2S3SDIM0 ", "       ",     "       ",    "       "},//37,38
                {"        0v", "        0v", "     0v",     "     0v",    "     0v"},
                {"GPIO3A5   ", "I2S0SDOM0 ", "       ",     "       ",    "       "},//39,40
                {NULL,         NULL,         NULL,          NULL,         NULL},
                {NULL,         NULL,         NULL,          NULL,         NULL},
                {NULL,         NULL,         NULL,          NULL,         NULL},
                {NULL,         NULL,         NULL,          NULL,         NULL},
