...
void doMode (int argc, char *argv []) {
    ...
    /**/ if (strcasecmp(mode, "in") == 0) asus_set_pin_mode(pin, INPUT);
    else if (strcasecmp(mode, "input") == 0) asus_set_pin_mode(pin, INPUT);
    else if (strcasecmp(mode, "out") == 0) asus_set_pin_mode(pin, OUTPUT);
    else if (strcasecmp(mode, "output") == 0) asus_set_pin_mode(pin, OUTPUT);
    else if (strcasecmp(mode, "pwm") == 0) asus_set_pin_mode(pin, PWM_OUTPUT);
    else if (strcasecmp(mode, "pwmTone") == 0) asus_set_pin_mode(pin, PWM_TONE_OUTPUT);
    else if (strcasecmp(mode, "clock") == 0) asus_set_pin_mode(pin, GPIO_CLOCK);
    else if (strcasecmp(mode, "up") == 0) asus_pullUpDnControl(pin, PUD_UP);
    else if (strcasecmp(mode, "down") == 0) asus_pullUpDnControl(pin, PUD_DOWN);
    else if (strcasecmp(mode, "tri") == 0) asus_pullUpDnControl(pin, PUD_OFF);
    else if (strcasecmp(mode, "off") == 0) asus_pullUpDnControl(pin, PUD_OFF);
